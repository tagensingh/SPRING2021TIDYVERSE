...
```{r boxplot4}
 b1<- ggplot(data = dfMarriage_Subset, aes(x ="", y=High_School_Or_Less)) +
  geom_boxplot() +
...
```{r graduate degree}
  ...
  g3<-ggplot(data = dfMarriage_Subset, aes(x =year, y=Graduate_Degree)) +
  geom_col() +
   ylab("Share of adults who have never married") +
    xlab("Year") +
...
Use Cowplot and grob to layout separate plots side-by-side (grid based plotting). Break title into main title and subtitle.
...
g1 <- ggplot(data = dfMarriage_Subset, aes(x =year, y=High_School_Or_Less)) +
  ...
  ylab("Share of adults who have never married") +
  xlab("Year") +
  ggtitle("Marriage Rates for Adults", subtitle = "High School Education or Less") +
...
g3<-ggplot(data = dfMarriage_Subset, aes(x =year, y=Graduate_Degree)) +
  ...
  ylab("Share of adults who have never married") +
  xlab("Year") + 
  ggtitle("Marriage Rates for Adults", subtitle = "Graduate Degree") +
  theme(plot.title=element_text(size=12, face="bold", colour="black", vjust=-1)) +
  my_theme()
...
ggdraw() +
  draw_plot(g1, x = 0, y = .2, width = .5, height = .75) +
  draw_plot(g3, x = .5, y = .2, width = .5, height = .75)
