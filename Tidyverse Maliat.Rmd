...
<span style="color:blue">Additionally, selecting movies release from 1937 to 1961 can be done using `filter()` function from the `dplyr` package as shown below.</span>
