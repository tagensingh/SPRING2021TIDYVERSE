...
I will now show the general fuzzyjoin package. I will feed it a custom matching function. This code performs the same task as the `stringdist_inner_join`, this is just to illustrate the custom matching function
